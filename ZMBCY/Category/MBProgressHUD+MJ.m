...
+(MBProgressHUD *)showMessage:(NSString *)message toButton:(UIButton *)sender inView:(UIView *)view andFrameView:(UIView *)superView{
    if (view == nil) view = [UIApplication sharedApplication].keyWindow;
    // 快速显示一个提示信息

    UIView *theView = [[UIView alloc] init];
    theView.frame = sender.frame;
    theView.backgroundColor = [UIColor clearColor];
    [view addSubview:theView];
    
    if (superView) {
        theView.frame = superView.frame;
    }
