...
@interface ZMStringPickerView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@property (nonatomic, copy) ZMStringResultBlock resultBlock;
// 单列选中的项
...
@implementation ZMStringPickerView
...
+ (void)showStringPickerWithTitle:(NSString *)title
    ...
    ZMStringPickerView *strPickerView = [[ZMStringPickerView alloc]initWithTitle:title dataSource:dataSource defaultSelValue:defaultSelValue isAutoSelect:isAutoSelect resultBlock:resultBlock];
...
- (UIPickerView *)pickerView {
    if (!_pickerView) {
        _pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, kTopViewHeight + 0.5, kScreenWidth, kDatePicHeight)];
